...
public_users.get('/isbn/:isbn', async function (req, res) {
    ...
    const book = await books[isbn.trim()];
    if (book) {
        res.send(book);
    } 
    else {
...
public_users.get('/author/:author', async function (req, res) {
    ...
    const authorFilter = await bookList.filter(book => book.author.trim() == author.trim());
...
public_users.get('/title/:title', async function (req, res) {
    ...
    const titleFilter = await bookList.filter(book => book.title.trim() == title.trim());
